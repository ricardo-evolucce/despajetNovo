...
class Servico extends Model
{
	...
	protected $fillable = ['servico', 'tiposervico_id', 'cliente_id', 'chassi', 'modelo', 'placa', 'renavam', 'data',
	...
	'guiaPago', 'valorPlacaEsp', 'placaEspPago', 'valorProvisorio', 'provisorioPago', 
	];
