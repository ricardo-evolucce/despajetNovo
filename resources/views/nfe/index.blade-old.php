...
@section('conteudo')
    ...
    <div class="containder-fluid">
        <form action="/nota-fiscal/filtrar" method="post">
            @csrf
            ...
            <tbody>
                @foreach ($servicos as $servico)
                    <tr>
                        ...
                        <td @if ($servico->provisorioPago == 0) class="text-danger" @endif>{{ $servico->valorProvisorio }}
                        </td>
                        <td @if ($servico->placaEspPago == 0) class="text-danger" @endif>{{ $servico->valorPlacaEsp }}
                        </td>
